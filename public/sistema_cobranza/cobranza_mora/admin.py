...
from .models import Cliente, Empresa, Direccion, Evento_telefono, Lista, Mora, Estado, Link_cliente, Lista_cliente, Evento_tipo, Evento_respuesta, Evento_pendiente, Telefono, Telefono_tipo
